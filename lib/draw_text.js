function drawState() {
  // ctx.font = "16px American Typewriter, serif";
...
function drawCrash() {
  // ctx.font = "40px American Typewriter, serif";
  ctx.font = "20px 'Press Start 2P'";
  ctx.fillStyle = "#EEE";
...
function drawLostFuel() {
  // ctx.font = "24px American Typewriter, serif";
  ctx.font = "20px 'Press Start 2P'";
  ctx.fillStyle = "#EEE";
  ctx.fillText('300 FUEL UNITS LOST', canvas.width/2 - 100, canvas.height/4 + 40)
}

function drawRetry() {
  // ctx.font = "20px American Typewriter, serif";
  ctx.font = "20px 'Press Start 2P'";
  ctx.fillStyle = "#EEE";
...
function drawClickToRetry() {
  // ctx.font = "20px American Typewriter, serif";
  ctx.fillStyle = "#EEE";
  ctx.fillText("Click to Start", canvas.width/2 - 50, canvas.height/4 +280);
}

function drawClickToNewGame() {
  // ctx.font = "20px American Typewriter, serif";
  ctx.fillStyle = "#EEE";
  ctx.fillText("Click to Start", canvas.width/2 - 50, canvas.height/4 +280);
}